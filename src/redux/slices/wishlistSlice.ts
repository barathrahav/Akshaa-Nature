...
export const wishlistSlice = createSlice({
  ...
  initialState,
  reducers: {
    wishlist_product: (state, { payload }: PayloadAction<CartProductTypeTwo>) => {
    ...
    remove_wishlist_product: (
      state,
      { payload }: PayloadAction<CartProductTypeTwo>
    ) => {
    ...
    decrease_quantity: (state, { payload }: PayloadAction<CartProductTypeTwo>) => {
